import type { OutstandingInvoicesResult } from "../api.js";
import { formatCents } from "../format.js";
import { statusBadge } from "./CustomerInvoicesTile.js";

interface OutstandingInvoicesTileProps {
  data: OutstandingInvoicesResult;
}

export function OutstandingInvoicesTile({ data }: OutstandingInvoicesTileProps) {
  return (
    <div className="flex justify-start">
      <div className="w-full max-w-[85%] rounded-3xl bg-white/[0.05] p-4 ring-1 ring-white/10">
        <p className="text-xs font-medium uppercase tracking-wide text-slate-400">
          Outstanding invoices — {data.count} total, {formatCents(data.totalCents)}
        </p>
